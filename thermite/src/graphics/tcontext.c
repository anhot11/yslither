...
void _tcontext_create_surface(tcontext* context, twindow* window) {
  ...
  VkAndroidSurfaceCreateInfoKHR create_info = {
      ...
      .pNext = NULL,
      .flags = 0,
      .window = window->a_window,
  };
  vkCreateAndroidSurfaceKHR(context->instance, &create_info, NULL, &context->surface);
#else
